...
global.MAGPIE_SYSTEM = {
    error: (msg, e) => { console.error("Error:", msg); if(e) console.error(e.stack); },
...
MAGPIE_PHYSICS.setPosition(povart, [6371008, 0, 0]);

console.log("Calling clamp...");
MAGPIE_PHYSICS._geod_clampToGround(6371008, [0, 0, 0], povart, 1);
console.log("Done.");
